 ...
 <div class="wrap">
   <%
					Registration s1 = new Registration(session);
						ArrayList<Details> ar = s1.getClients();
...
<div class="flex">
 ...
 <%
					Registration s2 = new Registration(session);
						ArrayList<Details> ar1 = s2.getClients();
...
<div id="detail">
  ...
  <input type="hidden" name="userid" value="<%=s.getId()%>" />
   <input type="hidden" name="mphone" value="<%=s.getNumber()%>" />
    <input type="hidden" name="sphone" value="<%=session.getAttribute("phone")%>" />
