...
<div class="container mt-5">
    ...
    <form action='register' method='POST' id="details">
        ...
        <div class="form-section">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3 profile-image-container">
                    <img src="<%=session.getAttribute("image") %>" alt="Profile Image" class="profile-image" id="profileImagePreview" >
               <!--      <input type="file" class="form-control custom-file-input" id="profileImage" name="image" accept="image/*" onchange="previewImage(event)">-->
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="profile" name="profile"  >
                                <option value="<%=s.getProfile() %>" selected><%=s.getProfile() %> </option>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="fullName" name="name" placeholder="Enter full name" value="<%=s.getName() %>"  >
                        </div>

                        <!-- Age -->
                        <div class="col-md-6 mb-3">
                            <label for="age" class="form-label">Age</label>
                            <input type="number" class="form-control" id="age" name="age" placeholder="Enter age" value="<%=s.getAge() %>"  >
                        </div>

                        <div class="col-md-6 mb-3">
                            <label for="dob" class="form-label">D.O.B</label>
                            <input type="date" class="form-control" id="dob" name="dob" placeholder="Enter dob" value="<%=s.getDob() %>" >
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="feet" name="feet" >
                                <option value="<%=s.getHeight() %>"  ><%=s.getHeight() %></option>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" id="weight" name="weight" placeholder="Enter your weight" min="1" step="0.1" value="<%=s.getWeight() %>">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="gender" name="gender" >
                                <option value="<%=s.getGender() %>" selected><%=s.getGender() %></option>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="maritalStatus" name="marital" >
                                <option value="<%=s.getMarital() %>" selected><%=s.getMarital() %></option>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="motherTongue" name="language" >
                                      ...
                                      <option value="<%=s.getLanguage() %>" selected><%=s.getLanguage() %></option>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="religion" name="religion" >
                        <option value="<%=s.getReligion() %>" selected><%=s.getReligion() %></option>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="caste" name="caste" placeholder="Enter caste" value="<%=s.getCaste() %>">
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="rashi" name="rashi" >
                        <option value="<%=s.getRashi() %>" selected><%=s.getRashi() %></option>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="nakshatra" name="star" >
                        <option value="<%=s.getStar() %>" selected><%=s.getStar() %></option>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="gotra" name="gotra" placeholder="Enter Gotra" value="<%=s.getGotra() %>" >
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="manglik" name="manglik" >
                        <option value="<%=s.getManglik() %>" selected><%=s.getManglik() %></option>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="time" class="form-control" id="birthTime" name="birthTime" value="<%=s.getBirthtime()%>" >
                </div>

                <!-- Birth Place -->
                <div class="col-md-6 mb-3">
                    <label for="birthPlace" class="form-label">Birth Place</label>
                    <input type="text" class="form-control" id="birthPlace" name="birthPlace" placeholder="Enter Birth Place" value="<%=s.getBirthplace() %>">
                </div>
            </div>
        </div>
            </div>
        ...
        <div class="form-section">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="country" name="country" placeholder="Enter country" value="<%=s.getCountry() %>" >
                </div>

                <!-- City -->
                <div class="col-md-6 mb-3">
                    <label for="city" class="form-label">State</label>
                    <input type="text" class="form-control" id="state" name="state" placeholder="Enter state" value="<%=s.getState() %>" >
                </div>

                <div class="col-md-6 mb-3">
                    <label for="city" class="form-label">City</label>
                    <input type="text" class="form-control" id="city" name="city" placeholder="Enter city" value="<%=s.getCity() %>">
                </div>

                <div class="col-md-6 mb-3">
                    <label for="city" class="form-label">Citizenship</label>
                    <input type="text" class="form-control" id="Citizenship" name="citizenship" placeholder="Enter citizenship" value="<%=s.getCitizenship() %>" >
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="Education" name="education" placeholder="Enter Education" value="<%=s.getEducation() %>" >
                </div>

                <div class="col-md-6 mb-3">
                    <label for="profession" class="form-label">Profession</label>
                    <input type="text" class="form-control" id="profession" name="profession" placeholder="Enter profession" value="<%=s.getProfession() %>" >
                </div>

                <div class="col-md-6 mb-3">
                    <label for="profession" class="form-label">Employed In</label>
                    <select class="form-select" id="employed" name="employed" >
                        <option value="<%=s.getEmployed() %>" selected><%=s.getEmployed() %></option>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="income" name="income" placeholder="Enter annual income" value="<%=s.getIncome() %>" >
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="siblings" name="siblings" placeholder="Enter number of siblings" value="<%=s.getSiblings() %>" >
                </div>

                <div class="col-md-6 mb-3">
                    <label for="location" class="form-label">Family Location</label>
                    <input type="text" class="form-control" id="location" name="location" placeholder="Enter current location" value="<%=s.getLocationn() %>" >
                </div>
            </div>
        </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control" id="interests" name="interests" rows="4" placeholder="Describe your hobbies and interests" value="<%=s.getInterests() %>" ></textarea>
                </div>
            </div>
        </div>
        ...
        <!-- Submit Button -->
            ...
            <div class="button">
            <button type="submit" class="button" style="background-color: blue;color:white;" name="update1">Update Profile</button>
        </div>
